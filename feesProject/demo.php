...
<html lang="en">
        ...
        <div class="collapse navbar-collapse" id="navbarSupportedContent">
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <a class="nav-link" href="receipt.php">Fees Receipt<span class="sr-only">(current)</span></a>
            </li>
            <li class="nav-item">
  ...
  <div class="center-form">
    <form action="pay.php" method="POST">
        ...
        <lable for="pmode">Payment mode:- </lable>
        <input type="text"  name="mode" ><br><br>

        <lable for="course">Course:- </lable>
        <input type="text"  name="course" ><br><br>

        <lable for="fees">Fees:- </lable>
        <input type="text"  name="fees" ><br><br>

        <lable for="status">Fees Status:- </lable>
        <input type="text"  name="stat" ><br><br>
